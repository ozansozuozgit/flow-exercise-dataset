# Arm slingers hanging straight legs — clean-room source brief
...
- Keep the same bar, grip spacing, clothing, torso, hip position, straight knees,
  and camera in every frame; no equipment may cross a quadrant boundary.
...
- Frame 00: dead hang with arms straight and both legs straight down together.
- Frame 01: controlled straight-leg raise to about 45 degrees; knees locked and
  arms/bar fixed.
- Frame 02: peak raise with straight legs parallel to the ground and toes
  pointed; torso stable and no swing.
